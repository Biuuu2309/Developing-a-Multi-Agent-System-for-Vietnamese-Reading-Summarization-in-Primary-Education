    ...
    switch (theme) {
      ...
      case "custom":
        return {
          ...
          button: "bg-transparent border-white/30 font-bold",
        };
      case "glass":
      default:
        return {
          ...
          button: "bg-black/30 border-white/10 font-bold",
        };
    }
          ...
          {!isMobile && !isSticky && (
            <motion.div
              ...
              style={{
                ...
                boxShadow: `inset 0 0 ${glowIntensity * 2}px rgba(255, 255, 255, ${glowIntensity * 0.1})`,
