  ...
  return (
    ...
    >
      ...
      <div className="text-center">
        <h2
          className={cn(
            // Text with transparent fill, color will come from aurora layers
            "font-extrabold tracking-tight relative overflow-visible text-transparent",
            textClassName
          )}
          style={{ 
            fontSize,
        ...
        >
          ...
          >
            {text}
            <div
              // Aurora layers positioned absolutely to fill text only
              className="absolute inset-0 z-10 pointer-events-none"
              style={{
                WebkitMaskImage: `linear-gradient(transparent, transparent), url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg"><text x="0" y="1em" font-size="${fontSize}" font-weight="800">${text}</text></svg>')`,
                maskImage: `linear-gradient(transparent, transparent), url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg"><text x="0" y="1em" font-size="${fontSize}" font-weight="800">${text}</text></svg>')`,
