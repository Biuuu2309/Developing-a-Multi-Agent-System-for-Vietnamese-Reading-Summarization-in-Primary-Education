    ...
    >
      ...
      <div className="text-center">
        <div className="relative inline-block">
          ...
          {/* Aurora layers container - will be masked by text using mix-blend-mode */}
          <div
            className="absolute inset-0 pointer-events-none"
            style={{
              // Use the text element above as a mask
              WebkitMaskImage: 'linear-gradient(black, black)',
              maskImage: 'linear-gradient(black, black)',
            }}
          >
            {/* Duplicate text for creating proper mask shape */}
            <h2
              className={cn(
            ...
            {/* Aurora layers - positioned behind mask text */}
            <div
              className="absolute inset-0"
              style={{
                // Clip to text shape using the white text above as mask
