    ...
    >
      ...
      <div className="text-center">
        <div className="relative inline-block">
          ...
          {/* Aurora layers container - positioned behind text, masked by text shape */}
          <div
            className="absolute inset-0 pointer-events-none"
            style={{
              // Use text as mask - create a duplicate text element for masking
              WebkitMaskImage: `-webkit-linear-gradient(black, black)`,
              maskImage: `linear-gradient(black, black)`,
            }}
          >
            {/* Duplicate text for mask - invisible but creates the mask shape */}
            <h2
              className={cn(
            ...
            {/* Aurora layers - will be visible only where text mask allows */}
            <div
