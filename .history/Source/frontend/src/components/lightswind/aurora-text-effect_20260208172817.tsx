      ...
      <div className="text-center">
        <h2
          className={cn(
            ...
            "font-extrabold tracking-tight relative inline-block",
            textClassName
          )}
          style={{ 
            fontSize,
        ...
        >
          {text}
          <div
            // Aurora layers positioned absolutely, masked to text shape
            className="absolute inset-0 z-10 pointer-events-none"
            style={{
              WebkitMaskImage: `url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg"><text x="0" y="1em" font-size="${fontSize}" font-weight="800" font-family="inherit">${text}</text></svg>')`,
              maskImage: `url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg"><text x="0" y="1em" font-size="${fontSize}" font-weight="800" font-family="inherit">${text}</text></svg>')`,
