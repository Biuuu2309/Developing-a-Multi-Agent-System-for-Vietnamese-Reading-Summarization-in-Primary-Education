    ...
    >
      ...
      <div className="text-center">
        <div className="relative inline-block">
          ...
          {/* Aurora layers container - positioned behind text */}
          <div
            className="absolute inset-0 pointer-events-none"
            style={{
              // Clip to text shape using CSS mask
              WebkitMaskImage: `-webkit-linear-gradient(black, black)`,
              maskImage: `linear-gradient(black, black)`,
            }}
          >
            {/* Duplicate text for mask - creates the text shape */}
            <h2
              className={cn(
            ...
            {/* Aurora layers - will be masked by text shape above */}
            <div
              className="absolute inset-0"
              style={{
                // Use the white text above as mask
