    ...
    >
      ...
      <div className="text-center">
        <div className="relative inline-block">
          ...
          {/* Aurora layers container - will be masked by text shape */}
          <div
            className="absolute inset-0 pointer-events-none"
            style={{
              // Use CSS mask to clip aurora to text shape
              isolation: 'isolate',
            }}
          >
            {/* Duplicate text for mask - white text creates the mask shape */}
            <h2
              className={cn(
            ...
            {/* Aurora layers - will be visible only through text mask */}
            <div
              className="absolute inset-0"
              style={{
                // Use mix-blend-mode to show only where white text is
                mixBlendMode: 'screen',
              }}
            >
              {/* First Aurora Layer */}
