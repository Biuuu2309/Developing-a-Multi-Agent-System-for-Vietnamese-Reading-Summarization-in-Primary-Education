    ...
    >
      ...
      <div className="text-center">
        <div className="relative inline-block">
          {/* Text element with aurora layers as background, clipped to text shape */}
          <h2
            className={cn(
          ...
          >
            {text}
            {/* Aurora layers container - positioned absolutely, will be clipped by background-clip: text */}
            <div
