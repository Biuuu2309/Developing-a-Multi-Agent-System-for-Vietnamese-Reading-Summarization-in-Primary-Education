    ...
    >
      ...
      <div className="text-center">
        <div className="relative inline-block">
          {/* Text element - transparent to show aurora behind */}
          <h2
            className={cn(
              "font-extrabold tracking-tight relative",
              textClassName
            )}
            style={{ 
              fontSize,
          ...
          {/* Aurora layers container - masked by text shape using CSS mask */}
          <div
            className="absolute inset-0 pointer-events-none"
            style={{
              // Create mask from duplicate text element
              isolation: 'isolate',
            }}
          >
            {/* Duplicate text for mask - creates the text shape for masking */}
            <h2
              className={cn(
            ...
            {/* Aurora layers - will be masked by text above */}
            <div
              className="absolute inset-0"
              style={{
                // Use the text above as mask
                WebkitMaskImage: 'url("data:image/svg+xml;utf8,<svg xmlns=\'http://www.w3.org/2000/svg\'><text x=\'0\' y=\'1em\' font-size=\'inherit\' font-weight=\'800\'>' + text + '</text></svg>")',
                maskImage: 'url("data:image/svg+xml;utf8,<svg xmlns=\'http://www.w3.org/2000/svg\'><text x=\'0\' y=\'1em\' font-size=\'inherit\' font-weight=\'800\'>' + text + '</text></svg>")',
