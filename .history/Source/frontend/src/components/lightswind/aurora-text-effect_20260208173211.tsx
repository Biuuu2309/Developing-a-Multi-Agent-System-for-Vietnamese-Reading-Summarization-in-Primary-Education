    ...
    >
      ...
      <div className="text-center">
        <div className="relative inline-block">
          ...
          {/* Aurora layers container - will be masked by text using CSS mask */}
          <div
            className="absolute inset-0 pointer-events-none"
            style={{
              // This container will be masked by the text element
              isolation: 'isolate',
            }}
          >
            {/* Duplicate text for creating mask - white text creates the mask shape */}
            <h2
              className={cn(
            ...
            {/* Aurora layers - will be visible only where white text is */}
            <div
              className="absolute inset-0"
              style={{
                // Use mix-blend-mode to show only where text is
                mixBlendMode: 'screen',
                // Clip to text shape - the white text above acts as mask
