                  ...
                  <GlowingCard glowColor="#b04bff" className="space-y-4">
                    ...
                    >
                      <div className="p-2 text-justify" style={{ fontSize: '1rem', margin: '10px' }}>
                        ...
                        Mô hình được Optuna qua 13 lần cho phiên bản 1 và 19 lần cho phiên bản 2, ViT5 được tinh chỉnh trên hơn 20.000 văn bản tóm tắt. Dữ liệu được chia 80% huấn luyện, 10% kiểm định, 10% kiểm tra. Siêu tham số tối ưu bằng Optuna phiên bản 2: <br />
