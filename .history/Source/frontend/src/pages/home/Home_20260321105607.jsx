        ...
        <div style={{ padding: '1rem 2rem' }}>
          <div className="container-fluid" style={{ width: '90%', marginLeft: '5%', marginRight: '5%', marginTop: '2.5%', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', zIndex: 1, borderRadius: '25px' }}>
            ...
            <div className="container-fluid HOME2" style={{ width: '100%', height: '100%', display: 'flex', justifyContent: 'center', alignItems: 'center', padding: '0', flexDirection: 'column' }}>
                ...
                >
                  ...
                  <InteractiveGradient
                    ...
                    >
                      ...
                      Mục tiêu 1: Nghiên cứu về hệ thống đa tác tử (multi-agent systems), các giải pháp kỹ thuật về giao tiếp giữa các tác tử, bao gồm cơ chế chia sẻ dữ liệu và cải thiện quy trình hợp tác của các tác tử cho tóm tắt văn bản tiếng Việt. <br /><br />
                      Mục tiêu 2: Thiết kế các tác tử, thu thập, tiền xử lý, gắn nhãn, tinh chỉnh và huấn luyện các mô hình cho tóm tắt trích xuất và tóm tắt diễn giải và tích hợp vào kiến trúc hệ thống đa tác tử.	Chọn lọc, kiểm tra, đối chiếu và đánh giá chất lượng bản tóm tắt thông qua các thang đo ROUGE, BLEU, BERTScore, từ điển cấp lớp để tạo bản tóm tắt phù hợp với cấp lớp theo yêu cầu về độ dài, từng vựng, cấu trúc văn bản. <br /><br />
                      Mục tiêu 3: Xây dựng ứng dụng đa tác tử có giao diện web hỗ trợ tóm tắt bài đọc tiếng Việt bậc tiểu học, cho phép điều chỉnh tóm tắt phù hợp cấp lớp.
                      </div>
                    </InteractiveGradient>
                  </GlowingCard>
              ...
              <div className="container-fluid" style={{ padding: '0', backgroundColor: 'transparent', height: 'auto', width: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', marginTop: '1%', marginBottom: '6%' }}>
                <GlowingCards
                  enableGlow={true}
                  glowRadius={30}
                  glowOpacity={0.8}
                ...
                >
                  <GlowingCard glowColor="#2d7cff" className="space-y-4">
                    ...
                    >
                      <div className="p-2 text-justify" style={{ fontSize: '1rem' }}>
                        Hệ thống MAS điều phối nhiều tác tử chuyên trách theo từng bước: hiểu yêu cầu, lập kế hoạch, sinh kết quả và kiểm tra chất lượng.
                        <br /><br />
                        Cách tiếp cận này giúp nâng cao tính ổn định, khả năng mở rộng và minh bạch trong quá trình tạo tóm tắt.
                      </div>
                    </InteractiveGradient>
                  </GlowingCard>
                  ...
                  <GlowingCard glowColor="#22a06b" className="space-y-4">
                    ...
                    >
                      <div className="p-2 text-justify" style={{ fontSize: '1rem' }}>
                        Mô hình trích xuất chọn các câu quan trọng nhất từ văn bản gốc để giữ lại ý chính và cấu trúc thông tin trọng tâm.
                        <br /><br />
                        Kết quả trung gian này là nền tảng vững chắc cho bước diễn giải ở giai đoạn tiếp theo.
                      </div>
                    </InteractiveGradient>
                  </GlowingCard>
                  ...
                  <GlowingCard glowColor="#b04bff" className="space-y-4">
                    ...
                    >
                      <div className="p-2 text-justify" style={{ fontSize: '1rem' }}>
                        Mô hình diễn giải chuyển nội dung trích xuất thành bản tóm tắt mạch lạc, dễ hiểu và phù hợp theo cấp lớp.
                        <br /><br />
                        Văn phong được tối ưu để học sinh tiếp cận nhanh, giảm quá tải thông tin và tăng hiệu quả đọc hiểu.
                      </div>
                    </InteractiveGradient>
                  </GlowingCard>
                </GlowingCards>
