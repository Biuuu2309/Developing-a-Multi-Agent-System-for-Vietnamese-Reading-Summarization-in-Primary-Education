                  ...
                  <GlowingCard glowColor="#ff1493" className="space-y-4">
                    ...
                    >
                      <div className="p-2 text-justify">
                        ...
                        Dựa trên hai bộ dữ liệu và bộ từ điển theo cấp lớp chuẩn sách giáo khoa được bộ giáo dục và đào tạo cung cấp. Mô hình được huấn luyện và tinh chỉnh sau khi optuna nhiều lần để đạt được độ chính xác cao nhất. Nhằm thu thập mô hình tốt nhất, tối ưu chi phí và thời gian. Độ chính xác và hiệu quả cao đã được kiểm chứng trên thực tế.
                      </div>
                    </InteractiveGradient>
                  </GlowingCard>
                </GlowingCards>
