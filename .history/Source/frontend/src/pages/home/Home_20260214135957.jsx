          ...
          <div className="container-fluid" style={{ width: '90%', marginLeft: '5%', marginRight: '5%', marginTop: '5.5%', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', zIndex: 1, borderRadius: '25px' }}>
            ...
            <div className="container-fluid HOME3" style={{ width: '100%', height: '100%', display: 'flex', justifyContent: 'center', alignItems: 'center', padding: '0', flexDirection: 'column' }}>
              <div className="container" style={{ padding: '0', backgroundColor: 'transparent', height: 'auto', width: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', marginTop: '2%', fontFamily: 'Merriweather', fontSize: '3rem', fontWeight: 'bold' }}>
                ...
                <ScrollList
                  data={[
                    { title: 'Step 1: Lời chào', description: 'Hệ thống gửi lời chào thân thiện và nhắc nhở về chức năng của hệ thống' },
                    { title: 'Step 2: Phân loại yêu cầu của người dùng', description: 'Phân loại yêu cầu của người dùng thành: lời chào, câu hỏi về hệ thống, câu hỏi hoặc yêu cầu KHÔNG liên quan đến tóm tắt' },
                    { title: 'Step 3: Phân loại đầu vào văn bản', description: 'Phân loại đầu vào văn bản từ nhiều định dạng khác nhau như: văn bản, ảnh, PDF' },
                    { title: 'Step 4: Hệ thống đa tác tử xử lý các nhiệm vụ chính', description: 'Hệ thống đa tác tử sẽ phân công nhiệm vụ cho các tác tử có chứng năng và chuyên môn phù hợp' },
