              ...
              <div className="container-fluid" style={{ padding: '0', backgroundColor: 'transparent', height: 'auto', width: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', marginTop: '2%' }}>
                ...
                >
                  <GlowingCard glowColor="#f59e0b" className="space-y-5">
                    <InteractiveGradient>
                      <div className="p-3 text-white" style={{ display: 'flex', flexDirection: 'row', alignItems: 'center' }} >
                        <img src="/images/problem.png" alt="" style={{ width: '12%', height: '12%', marginRight: '10px' }} />
                        <h3 style={{ marginLeft: '10px', color: '#e2b85c', fontSize: '1.3rem', margin: '0' }}>Vấn đề thực tiễn</h3>
                      </div>
                    </InteractiveGradient>
                    <InteractiveGradient
                      color="#1890ff"
                      ...
                      borderRadius="1.5rem"
                    >
                      <div className="p-2 text-white, display: flex; flex-direction: column; align-items: center; justify-content: center;, text-align: justify;">
