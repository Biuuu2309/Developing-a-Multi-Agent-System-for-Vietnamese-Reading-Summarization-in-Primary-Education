            ...
            <div className="container-fluid HOME2" style={{ width: '100%', height: '100%', display: 'flex', justifyContent: 'center', alignItems: 'center', padding: '0', flexDirection: 'column' }}>
              ...
              <div className="container-fluid" style={{ padding: '0', backgroundColor: 'transparent', height: 'auto', width: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', marginTop: '2%' }}>
                <GlowingCards
                  ...
                  responsive={true}
                >
                  <GlowingCard glowColor="#ff7f2d" className="space-y-5">
                    <InteractiveGradient
                      color="#ffc8a4"
                      glowColor="#ffb261"
                      followMouse={true}
                    ...
                    >
                      <div className="p-3 text-white rounded-xl" style={{ display: 'flex', flexDirection: 'row', alignItems: 'center' }} >
                        ...
                        <h3 style={{ color: '#df8144', fontSize: '1.2rem', margin: '0' }}>Vấn đề thực tiễn</h3>
                      </div>
                    </InteractiveGradient>
                    <InteractiveGradient
                      color="#1890ff"
                  ...
                  <GlowingCard glowColor="#ffcc33" className="space-y-4">
                    ...
                    >
                      <div className="p-3 text-white rounded-xl" style={{ display: 'flex', flexDirection: 'row', alignItems: 'center' }} >
                        ...
                        <h3 style={{ color: '#d0a116', fontSize: '1.2rem', margin: '0' }}>Phương pháp nghiên cứu</h3>
                      </div>
                    </InteractiveGradient>
                    <InteractiveGradient
                      color="#661010"
              ...
              <div className="container-fluid" style={{ padding: '0', backgroundColor: 'transparent', height: 'auto', width: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', marginTop: '1%', marginBottom: '6%' }}>
                ...
                >
                  <GlowingCard glowColor="#2d7cff" className="space-y-4">
                    ...
                    >
                      <div className="p-3 text-white rounded-xl" style={{ display: 'flex', flexDirection: 'row', alignItems: 'center' }} >
                        <img src="/images/management.png" alt="" style={{ width: '12%', height: '12%', marginRight: '5px' }} />
                  ...
                  <GlowingCard glowColor="#22a06b" className="space-y-4">
                    ...
                    >
                      <div className="p-3 text-white rounded-xl" style={{ display: 'flex', flexDirection: 'row', alignItems: 'center' }} >
                        <img src="/images/text.png" alt="" style={{ width: '12%', height: '12%', marginRight: '5px' }} />
                  ...
                  <GlowingCard glowColor="#b04bff" className="space-y-4">
                    ...
                    >
                      <div className="p-3 text-white rounded-xl" style={{ display: 'flex', flexDirection: 'row', alignItems: 'center' }} >
                        <img src="/images/chatbot.png" alt="" style={{ width: '12%', height: '12%', marginRight: '5px' }} />
