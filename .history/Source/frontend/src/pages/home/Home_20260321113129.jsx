                  ...
                  <GlowingCard glowColor="#2d7cff" className="space-y-4">
                    ...
                    >
                      <div className="p-2 text-justify" style={{ fontSize: '1rem' }}>
                        ...
                        Kiến trúc MAS được chia thành 2 hệ thống: Hệ thống 1 chứa các mô hình đã được huấn luyện cho tóm tắt trích xuất và diễn giải, cùng cơ chế điều phối trung tâm. Hệ thống 2 đảm nhiệm xử lý ngôn ngữ tự nhiên, phân loại ý định, chuẩn hóa đầu vào, đánh giá đầu ra và quản lý bộ nhớ ngữ cảnh. Các mô hình được kết nối với cơ sở dữ liệu vector Chroma để hỗ trợ truy xuất ngữ nghĩa khi cần. <br /><br />
