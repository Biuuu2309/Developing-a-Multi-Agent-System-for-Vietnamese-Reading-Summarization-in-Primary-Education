              ...
              <div className="container" style={{ padding: '0', backgroundColor: 'transparent', height: 'auto', width: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', marginTop: '2%', fontFamily: 'Merriweather', fontSize: '3rem', fontWeight: 'bold' }}>
                ...
                <ScrollList
                  data={[
                    ...
                    { title: 'Step 3: Phân loại đầu vào văn bản', description: 'Người dùng sẽ có những trường hợp và nhu cầu định dạng khác nhau. Việc thiết kế ứng dụng đa dạng góp phần trải nghiệm người dùng một cách tốt nhất.' },
                    { title: 'Step 5: Extractor', description: 'Extractor là tác tử chuyên tóm tắt văn bản theo cách TRÍCH XUẤT' },
                    { title: 'Step 6: Abstracter', description: 'Abstracter là tác tử chuyên tóm tắt văn bản theo cách DIỄN GIẢI' },
