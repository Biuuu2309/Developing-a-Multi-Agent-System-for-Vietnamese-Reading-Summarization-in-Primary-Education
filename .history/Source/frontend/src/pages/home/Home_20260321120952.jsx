              ...
              <div className="container-fluid" style={{ padding: '0', backgroundColor: 'transparent', height: 'auto', width: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', marginTop: '1%', marginBottom: '6%' }}>
                ...
                >
                  ...
                  <GlowingCard glowColor="#b04bff" className="space-y-4">
                    ...
                    >
                      <div className="p-2 text-justify" style={{ fontSize: '1rem', margin: '10px' }}>
                        Phương pháp diễn giải tạo bản tóm tắt bằng cách hiểu nội dung tổng thể và diễn đạt lại các ý chính trong một văn bản mới, tương tự cách con người tóm lược. Thường dựa trên các mô hình học sâu, đặc biệt là mô hình ngôn ngữ lớn, phương pháp này cho phép tạo ra nội dung ngắn gọn, mạch lạc và tự nhiên. <br /><br />
                        Mô hình được Optuna qua 13 lần cho phiên bản 1 và 19 lần cho phiên bản 2, ViT5 được tinh chỉnh trên hơn 20.000 văn bản tóm tắt. Dữ liệu được chia 80% huấn luyện, 10% kiểm định, 10% kiểm tra. Siêu tham số tối ưu bằng Optuna với phiên bản 1: <br />
                        learning_rate: 0.00016182079924163 <br />
                        batch_size: 4 <br />
                        grad_acc: 4 <br />
                        num_train_epochs: 4 <br />
                        max_len: 256 <br />
                        weight_decay: 0.04882386451981497 <br />
                        warmup_ratio: 0.05369923420365605. <br /><br />
