  ...
  return (
    <div style={{ width: '100%', minHeight: '100vh', position: 'relative' }}>
      ...
      <div className="container-fluid" style={{ width: '80%', marginLeft: '10%', marginRight: '10%', marginTop: '7%', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', zIndex: 1 }}>
        <div className="container" style={{ width: '100%', height: '100%', display: 'flex', justifyContent: 'center', alignItems: 'center', padding: '0' }}>
          <div className="container" style={{ width: '20%', height: '20%', display: 'flex', justifyContent: 'center', alignItems: 'center', padding: '0' }}>
          </div>
          <div className="container">
          <img src="/images/flat-university-background.png" alt="" />
          </div>
        </div>
      </div>
    </div>
