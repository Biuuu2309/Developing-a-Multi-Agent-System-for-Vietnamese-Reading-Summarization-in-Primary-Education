                ...
                <ScrollList
                  ...
                  renderItem={(item) => (
                    <div style={{ color: '#ffffff' }}>
                      <h3 className="font-semibold text-justify" style={{ fontSize: '1.2rem', fontFamily: 'sans-serif', fontWeight: 'bold', color: '#ffffff' }}>{item.title}</h3>
                      <p className="text-justify" style={{ fontSize: '1rem', fontFamily: 'sans-serif', fontWeight: 'normal', color: '#ffffff' }}>{item.description}</p>
                    </div>
                  )}
                  itemSpacing={24}
                />
