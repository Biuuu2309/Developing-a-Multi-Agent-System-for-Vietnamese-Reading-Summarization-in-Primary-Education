              ...
              <div className="container-fluid" style={{ padding: '0', backgroundColor: 'transparent', height: 'auto', width: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', marginTop: '2%' }}>
                ...
                >
                  ...
                  <GlowingCard glowColor="#ff1493" className="space-y-4">
                    ...
                    >
                      <div className="p-2 text-justify">
                        Dựa trên hai bộ dữ liệu trích xuất (hơn 300 nghìn dòng), diễn giải (hơn 20 nghìn văn bản) và bộ từ điển theo cấp lớp chuẩn sách giáo khoa được bộ giáo dục và đào tạo cung cấp. Mô hình được huấn luyện và tinh chỉnh sau khi optuna nhiều lần để đạt được độ chính xác cao nhất. Nhằm huấn luyện mô hình tốt nhất, tối ưu chi phí và thời gian. Độ chính xác và hiệu quả cao đã được kiểm chứng trên thực tế.<br /><br />
