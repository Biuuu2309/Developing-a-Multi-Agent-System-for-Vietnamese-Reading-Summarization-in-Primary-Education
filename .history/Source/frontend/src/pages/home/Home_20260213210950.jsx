        ...
        <div style={{ padding: '6rem 2rem' }}>
          <div className="container-fluid" style={{ width: '90%', marginLeft: '5%', marginRight: '5%', marginTop: '5.5%', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', zIndex: 1, borderRadius: '25px' }}>
            ...
            <div className="container-fluid HOME2" style={{ width: '100%', height: '100%', display: 'flex', justifyContent: 'center', alignItems: 'center', padding: '0', flexDirection: 'column' }}>
                  ...
                  <GlowingCard glowColor="#ff1493" className="space-y-4">
                    ...
                    >
                      <div className="p-3 text-white border-3 border-pink-300 rounded-xl" style={{ display: 'flex', flexDirection: 'row', alignItems: 'center' }} >
                        ...
                        <h3 style={{ color: '#ff1493', fontSize: '1.2rem', margin: '0' }}>Phương pháp nghiên cứu</h3>
                      </div>
                    </InteractiveGradient>
                    <InteractiveGradient
                      color="#661010"
              ...
              <div className="container-fluid" style={{ padding: '0', backgroundColor: 'transparent', height: 'auto', width: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', marginTop: '2%', border: '3px solid #ff1493' }}>
                <GlowingCards style={{ border: '3px solid #ff1493' }}>
                  <GlowingCard glowColor="#ff1493" className="space-y-4" style={{ border: '3px solid #ff1493' }}>
                    <InteractiveGradient
                      color="#661010"
                      glowColor="#ff1493"
                      followMouse={true}
                      ...
                      height="100%"
                      borderRadius="1.5rem"
                      style={{ border: '3px solid #ff1493' }}
                    >
                      <div className="p-3 text-white rounded-xl" style={{ display: 'flex', flexDirection: 'row', alignItems: 'center', minWidth: '100%', justifyContent: 'center', border: '3px solid #ff1493' }} >
                        <img src="/images/energy-saving-light.png" alt="" style={{ width: '5%', height: '5%', marginRight: '5px' }} />
                        <h3 style={{ color: '#ff1493', fontSize: '1.2rem', margin: '0' }}>Phương pháp nghiên cứu</h3>
                      </div>
                    </InteractiveGradient>
                    <InteractiveGradient
