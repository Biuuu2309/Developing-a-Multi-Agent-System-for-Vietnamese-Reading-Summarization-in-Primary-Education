                ...
                <div style={{ position: 'relative', zIndex: 2 }}>
                  <ScrollList
                    data={[
                      ...
                      { title: '5. Flask trả JSON → Spring ghi database', description: 'Sau khi Flask trả final_output, intent, plan, summary, evaluation, … Spring lưu (từng phần có dữ liệu): 1.Snapshot một lượt chạy MAS; 2. Chi tiết kế hoạch; 3. Đánh giá; 4. Goal / negotiation / confidence / agent memory; 5. Tin nhắn bot; 6. Log theo agent; Endpoint POST /api/summary-histories/create-from-mas là nhánh khác (liên kết lịch sử tóm tắt với kết quả MAS khi UI gọi), bổ sung cho luồng trên chứ không thay thế toàn bộ processChat.' },
