                ...
                >
                  ...
                  <InteractiveGradient
                    ...
                    >
                      ...
                      Mục tiêu 2: Thiết kế các tác tử, tiền xử lý, tinh chỉnh, huấn luyện các mô hình tóm tắt trích xuất, diễn giải và tích hợp vào kiến trúc hệ thống đa tác tử.	Chọn lọc, kiểm tra và đánh giá chất lượng bản tóm tắt thông qua các thang đo ROUGE, BERTScore, từ điển cấp lớp để tạo bản tóm tắt phù hợp cả về độ dài, từng vựng, cấu trúc văn bản. <br /><br />
