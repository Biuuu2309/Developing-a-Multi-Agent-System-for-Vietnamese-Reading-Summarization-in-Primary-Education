              ...
              <div className="container-fluid" style={{ padding: '0', backgroundColor: 'transparent', height: 'auto', width: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', marginTop: '2%' }}>
                ...
                >
                  ...
                  <InteractiveGradient
                    ...
                    >
                      <div className="p-2 text-justify">
                        ...
                        Việc sử dụng các mô hình học sâu đã được huấn luyện sẵn và được tinh chỉnh để tạo ra bản tóm tắt phù hợp cả về nội dung, độ dài, từ vựng và cấu trúc ngữ pháp. <br /><br />
                  ...
                  <GlowingCard glowColor="#ff1493" className="space-y-4">
                    ...
                    >
                      <div className="p-2 text-justify">
                        Dựa trên hai bộ dữ liệu chuẩn sách giáo khoa được bộ giáo dục và đào tạo cung cấp. Mô hình được huấn luyện và tinh chỉnh để tạo ra bản tóm tắt phù hợp cả về nội dung, độ dài, từ vựng và cấu trúc ngữ pháp. <br /><br />
                      </div>
                    </InteractiveGradient>
                  </GlowingCard>
                </GlowingCards>
