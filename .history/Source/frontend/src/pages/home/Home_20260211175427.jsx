              ...
              <div className="container" style={{ padding: '0', backgroundColor: 'transparent', height: 'auto', width: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', marginTop: '2%' }}>
                ...
                >
                  <GlowingCard glowColor="#f59e0b" className="space-y-4">
                    <div className="container" style={{ padding: '0', backgroundColor: 'transparent', height: 'auto', width: '100%', display: 'flex', flexDirection: 'r' }}>
                      <img src="/images/problem.png" alt="" style={{ width: '100px', height: '100px' }} />
                      <h3>Đặt vấn đề</h3>
                    </div>
                    <p>Enterprise-grade components...</p>
                  </GlowingCard>
                  <GlowingCard glowColor="#f59e0b" className="space-y-4">
                    <h3>Mục tiêu hướng đến</h3>
                    <p>Enterprise-grade components...</p>
                  </GlowingCard>
                  <GlowingCard glowColor="#f59e0b" className="space-y-4">
