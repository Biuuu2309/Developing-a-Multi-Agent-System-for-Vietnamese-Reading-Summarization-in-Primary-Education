...
import { Zap, Sparkles, Crown, BookOpen } from "lucide-react";
...
export default function Home() {
  ...
  const navLinks = useMemo(() => [
    ...
    { id: 'summary', label: 'Summary', href: '#summary', icon: <BookOpenIcon size={30} /> },
    { id: 'story', label: 'Story', href: '#story', icon: <BookOpen size={30} /> },
