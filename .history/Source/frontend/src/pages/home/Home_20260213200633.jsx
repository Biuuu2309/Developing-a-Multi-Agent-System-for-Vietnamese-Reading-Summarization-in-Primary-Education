                ...
                >
                  <GlowingCard glowColor="#227568" className="space-y-5">
                    <InteractiveGradient
                      ...
                      borderRadius="1.5rem"
                    >
                      <div className="p-3 text-white border-3 border-green-700 rounded-xl" style={{ display: 'flex', flexDirection: 'row', alignItems: 'center' }} >
                        <img src="/images/problem.png" alt="" style={{ width: '12%', height: '12%', marginRight: '10px' }} />
                        <h3 style={{ marginLeft: '10px', color: '#277522', fontSize: '1.3rem', margin: '0' }}>Vấn đề thực tiễn</h3>
                      </div>
                    </InteractiveGradient>
                    <InteractiveGradient
                      color="#1890ff"
                  ...
                  <InteractiveGradient
                      ...
                      borderRadius="1.5rem"
                    >
                      <div className="p-3 text-white border-3 border-purple-700 rounded-xl" style={{ display: 'flex', flexDirection: 'row', alignItems: 'center' }} >
                        <img src="/images/target.png" alt="" style={{ width: '12%', height: '12%', marginRight: '10px' }} />
                        <h3 style={{ marginLeft: '10px', color: '#940cd5', fontSize: '1.3rem', margin: '0' }}>Mục tiêu nghiên cứu</h3>
                      </div>
                    </InteractiveGradient>
                    <InteractiveGradient
                      color="#8d2799"
                  ...
                  <GlowingCard glowColor="#ff1493" className="space-y-4">
                    <InteractiveGradient
                      ...
                      borderRadius="1.5rem"
                    >
                      <div className="p-3 text-white border-3 border-pink-300 rounded-xl" style={{ display: 'flex', flexDirection: 'row', alignItems: 'center' }} >
                        <img src="/images/energy-saving-light.png" alt="" style={{ width: '12%', height: '12%' }} />
                        <h3 style={{ marginLeft: '10px', color: '#ff1493', fontSize: '1.3rem', margin: '0' }}>Phương pháp nghiên cứu</h3>
                      </div>
                    </InteractiveGradient>
                    <InteractiveGradient
                      color="#661010"
                    ...
                    >
                      <div className="p-2 text-justify">
                        Bộ dữ liệu đã trải qua các bước tiền xử lý, sinh dữ liệu, chọn lọc và tổng hợp một cách cực kỳ chặt chẽ, rõ ràng, minh bạch dựa trên cơ sở khoa học và suy luận logic, đảm bảo tính khách quan và độ tin cậy cao.<br /><br />
                        Dựa trên hai bộ dữ liệu trích xuất (hơn 300 nghìn dòng), diễn giải (hơn 20 nghìn văn bản) và bộ từ điển theo cấp lớp chuẩn sách giáo khoa được bộ giáo dục và đào tạo cung cấp. Mô hình được huấn luyện và tinh chỉnh sau khi optuna nhiều lần để đạt được độ chính xác cao nhất. Nhằm thu thập mô hình tốt nhất, tối ưu chi phí và thời gian. Độ chính xác và hiệu quả cao đã được kiểm chứng trên thực tế.
                      </div>
                    </InteractiveGradient>
                  </GlowingCard>
                </GlowingCards>
