              ...
              <div className="container" style={{ padding: '0', backgroundColor: 'transparent', height: 'auto', width: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', marginTop: '2%', fontFamily: 'Merriweather', fontSize: '3rem', fontWeight: 'bold' }}>
                ...
                <ScrollList
                  data={[
                    ...
                    { title: 'Step 5', description: 'Description for Step 5' },
                    { title: 'Step 6', description: 'Description for Step 6' },
                    { title: 'Step 7', description: 'Description for Step 7' },
                    { title: 'Step 8', description: 'Description for Step 8' },
                    { title: 'Step 9', description: 'Description for Step 9' },
                    { title: 'Step 10', description: 'Description for Step 10' },
                  ]}
                  renderItem={(item) => (
