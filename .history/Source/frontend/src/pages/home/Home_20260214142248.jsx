              ...
              <div className="container" style={{ padding: '0', backgroundColor: 'transparent', height: 'auto', width: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', marginTop: '2%', fontFamily: 'Merriweather', fontSize: '3rem', fontWeight: 'bold' }}>
                ...
                <ScrollList
                  data={[
                    ...
                    { title: 'Step 3: Phân loại yêu cầu của người dùng', description: 'Phân loại yêu cầu của người dùng, chọn lọc phản hồi của người dùng và đưa ra câu trả lời phù hợp và hướng dẫn người dùng để hệ thống có thể hiểu và xử lý yêu cầu một cách chính xác.' },
