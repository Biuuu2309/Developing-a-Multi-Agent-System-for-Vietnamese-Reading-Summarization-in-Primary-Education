                  ...
                  <GlowingCard glowColor="#b04bff" className="space-y-4">
                    ...
                    >
                      <div className="p-2 text-justify" style={{ fontSize: '1rem', margin: '10px' }}>
                        ...
                        Mô hình được Optuna qua 13 lần cho phiên bản 1 và 20 lần cho phiên bản 2, ViT5 được tinh chỉnh trên hơn 20.000 văn bản tóm tắt. Dữ liệu được chia 80% huấn luyện, 10% kiểm định, 10% kiểm tra. Siêu tham số tối ưu bằng Optuna: <br />
                        ...
                        - eval_rouge1: 0.7016 <br />
                        - eval_rouge2: 0.3397 <br />
                        - eval_rougeL: 0.3580 <br /> <br />
