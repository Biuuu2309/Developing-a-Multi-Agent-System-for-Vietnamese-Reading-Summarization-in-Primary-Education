                ...
                <GlowingCards>
                  <GlowingCard glowColor="#ff1493" className="space-y-4">
                    <InteractiveGradient
                      ...
                      borderRadius="1.5rem"
                    >
                      <div className="p-3 text-white rounded-xl" style={{ display: 'flex', flexDirection: 'row', alignItems: 'center', width: '100%', maxWidth: '100%', justifyContent: 'center', border: '3px solid #ff1493', boxSizing: 'border-box', overflow: 'hidden' }} >
