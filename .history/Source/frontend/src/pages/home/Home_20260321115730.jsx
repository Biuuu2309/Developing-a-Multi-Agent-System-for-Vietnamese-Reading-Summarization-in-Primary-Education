                  ...
                  <GlowingCard glowColor="#22a06b" className="space-y-4">
                    ...
                    >
                      <div className="p-2 text-justify" style={{ fontSize: '1rem', margin: '10px' }}>
                        ...
                        Với mẫu kiểm tra, PhoBERT đạt ROUGE-1-F1 0.5, ROUGE-L-F1 0.41, BERTScore-F1 0.85. Nhìn chung, mô hình đã đạt được độ chính xác cao, vừa tối ưu về chi phí và thời gian, vừa đảm bảo tính hiệu quả và chất lượng đầu ra.
                      </div>
                    </InteractiveGradient>
                  </GlowingCard>
