...
export default function Home() {
  ...
  return (
    <div className="container-fluid" style={{ display: 'flex', justifyContent: 'center', marginBottom: '2000px', marginTop: '2000px' }}>
              <ScrollStack
                itemDistance = "10"
                itemScale = "0.015"
              ...
              >
                <ScrollStackItem>
                  <div style={{ background: 'rgba(255, 255, 255, 0.9)', padding: '2rem', borderRadius: '20px', boxShadow: '0 4px 6px rgba(0, 0, 0, 0.1)' }}>
                    <h2>Card 1</h2>
