              ...
              <div className="container" style={{ padding: '0', backgroundColor: 'transparent', height: 'auto', width: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', marginTop: '2%', fontFamily: 'Merriweather', fontSize: '3rem', fontWeight: 'bold' }}>
                ...
                <ScrollList
                  data={[
                    ...
                    { title: 'Step 7: Coordinator', description: 'Coordinator là tác tử chuyên tổng hợp kết quả từ Extractor và Abstracter' },
                    { title: 'Step 8: Aggregator', description: 'Aggregator là tác tử chuyên tổng hợp kết quả từ Coordinator' },
                    { title: 'Step 9: User', description: 'User là tác tử chuyên nhận và xử lý yêu cầu của người dùng' },
                    { title: 'Step 10: System', description: 'System là tác tử chuyên nhận và xử lý yêu cầu của hệ thống' },
                  ]}
                  renderItem={(item) => (
