                ...
                >
                  <GlowingCard glowColor="#f59e0b" className="space-y-4">
                    <div className="container" style={{ padding: '0', backgroundColor: 'transparent', height: 'auto', width: '100%', display: 'flex', flexDirection: 'row' }}>
                      ...
                      <h3 style={{ marginLeft: '10px', color: '#e2b85c' }}>Đặt vấn đề</h3>
                    </div>
                  ...
                  <GlowingCard glowColor="#f59e0b" className="space-y-4">
                    <div className="container" style={{ padding: '0', backgroundColor: 'transparent', height: 'auto', width: '100%', display: 'flex', flexDirection: 'row' }}>
                      ...
                      <h3 style={{ marginLeft: '10px', color: '#f2d18a' }}>Mục tiêu hướng đến</h3>
                    </div>
                    <p>Enterprise-grade components...</p>
                  </GlowingCard>
                  <GlowingCard glowColor="#f59e0b" className="space-y-4">
                    <div className="container" style={{ padding: '0', backgroundColor: 'transparent', height: 'auto', width: '100%', display: 'flex', flexDirection: 'row' }}>
                      <img src="/images/meaning.png" alt="" style={{ width: '12%', height: '12%' }} />
                      <h3 style={{ marginLeft: '10px', color: '#f2d18a' }}>Ý nghĩa thực tiễn</h3>
                    </div>
                    <p>Enterprise-grade components...</p>
                  </GlowingCard>
                </GlowingCards>
