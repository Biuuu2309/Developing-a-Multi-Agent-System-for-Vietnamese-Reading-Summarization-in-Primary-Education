                ...
                >
                  ...
                  <GlowingCard glowColor="#661010" className="space-y-4">
                    <InteractiveGradient
                      ...
                      borderRadius="1.5rem"
                    >
                      <div className="p-3 text-white border-3 border-b-fuchsia-800 rounded-xl" style={{ display: 'flex', flexDirection: 'row', alignItems: 'center' }} >
                        <img src="/images/energy-saving-light.png" alt="" style={{ width: '12%', height: '12%' }} />
                        <h3 style={{ marginLeft: '10px', color: '#661010', fontSize: '1.3rem', margin: '0' }}>Phương pháp nghiên cứu</h3>
                      </div>
                    </InteractiveGradient>
                    <InteractiveGradient
                      color="#661010"
