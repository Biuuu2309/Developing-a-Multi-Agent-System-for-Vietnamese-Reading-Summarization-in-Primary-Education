...
export default function Home() {
  ...
  return (
    <div style={{ width: '100%', minHeight: '100vh', position: 'relative' }}>
      <div className="fixed-logo" style={{ display: 'flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'center', backgroundColor: 'rgba(255, 255, 255, 0.1)' }}>
        <img src="/images/logo.png" alt="" style={{ width: '100px', height: '100px' }} />
        <h1 style={{ margin: '0', fontSize: '2rem', fontWeight: 'bold', color: '#7dcb88', fontFamily: 'Merriweather'}}>VUSUMMARY</h1>
      </div>
      <SplashCursor />
      <ParticlesBackground
