                ...
                >
                  <GlowingCard glowColor="#f59e0b" className="space-y-4">
                    <div className="container" style={{ padding: '0', backgroundColor: 'transparent', height: 'auto', width: '100%', display: 'flex', flexDirection: 'row', alignItems: 'center' }}>
                      ...
                      <h3 style={{ marginLeft: '10px', color: '#e2b85c', fontSize: '1.2rem' }}>Vấn đề thực tiễn</h3>
                    </div>
                  ...
                  <GlowingCard glowColor="#f59e0b" className="space-y-4">
                    <div className="container" style={{ padding: '0', backgroundColor: 'transparent', height: 'auto', width: '100%', display: 'flex', flexDirection: 'row', alignItems: 'center' }}>
                      ...
                      <h3 style={{ marginLeft: '10px', color: '#e2b85c', fontSize: '1.2rem' }}>Mục tiêu nghiên cứu</h3>
                    </div>
                    <p>Enterprise-grade components...</p>
                  </GlowingCard>
                  <GlowingCard glowColor="#f59e0b" className="space-y-4">
                    <div className="container" style={{ padding: '0', backgroundColor: 'transparent', height: 'auto', width: '100%', display: 'flex', flexDirection: 'row', alignItems: 'center' }}>
                      ...
                      <h3 style={{ marginLeft: '10px', color: '#e2b85c', fontSize: '1.2rem' }}>Phương pháp nghiên cứu</h3>
                    </div>
                    <p>Enterprise-grade components...</p>
                  </GlowingCard>
                </GlowingCards>
