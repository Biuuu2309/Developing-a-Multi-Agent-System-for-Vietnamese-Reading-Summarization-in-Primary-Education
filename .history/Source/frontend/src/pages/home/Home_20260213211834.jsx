                ...
                <GlowingCards>
                  <GlowingCard glowColor="#ff1493" className="space-y-4">
                    <InteractiveGradient
                      ...
                      className="p-0"
                    >
                      <div className="p-3 text-white rounded-xl" style={{ display: 'flex', flexDirection: 'row', alignItems: 'center', width: '100%', maxWidth: '100%', justifyContent: 'center', border: '3px solid #ff1493', boxSizing: 'border-box', minWidth: 0 }} >
