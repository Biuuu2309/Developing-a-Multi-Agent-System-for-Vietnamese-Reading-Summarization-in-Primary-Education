        ...
        <div style={{ padding: '6rem 2rem' }}>
          <div className="container-fluid" style={{ width: '90%', marginLeft: '5%', marginRight: '5%', marginTop: '5.5%', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', zIndex: 1, borderRadius: '25px' }}>
            ...
            <div className="container-fluid HOME2" style={{ width: '100%', height: '100%', display: 'flex', justifyContent: 'center', alignItems: 'center', padding: '0', flexDirection: 'column' }}>
              <div className="container-fluid" style={{ padding: '0', backgroundColor: 'transparent', height: 'auto', width: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', marginTop: '2%', fontFamily: 'Merriweather', fontSize: '3rem', fontWeight: 'bold' }}>
                <ShinyText
                  text="Về hệ thống ?"
                  speed={3.3}
                  delay={0}
              ...
              <div className="container" style={{ padding: '0', backgroundColor: 'transparent', height: 'auto', width: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', marginTop: '2%' }}>
                <GlowingCards
                  enableGlow={true}
                  glowRadius={30}
                  glowOpacity={0.8}
                ...
                >
                  <GlowingCard glowColor="#f59e0b" className="space-y-4">
                    <div className="container" style={{ padding: '0', backgroundColor: 'transparent', height: 'auto', width: '100%', display: 'flex', flexDirection: 'row' }}>
                      ...
                      <h3 style={{ marginLeft: '10px', color: '#e2b85c' }}>Vấn đề thực tiễn & Tính cấp thiết</h3>
                    </div>
                  ...
                  <GlowingCard glowColor="#f59e0b" className="space-y-4">
                    <div className="container" style={{ padding: '0', backgroundColor: 'transparent', height: 'auto', width: '100%', display: 'flex', flexDirection: 'row' }}>
                      ...
                      <h3 style={{ marginLeft: '10px', color: '#e2b85c' }}>Mục tiêu & Đối tượng nghiên cứu</h3>
                    </div>
                    <p>Enterprise-grade components...</p>
                  </GlowingCard>
                  <GlowingCard glowColor="#f59e0b" className="space-y-4">
                    <div className="container" style={{ padding: '0', backgroundColor: 'transparent', height: 'auto', width: '100%', display: 'flex', flexDirection: 'row' }}>
                      ...
                      <h3 style={{ marginLeft: '10px', color: '#e2b85c' }}>Phương pháp & Giải pháp nghiên cứu</h3>
                    </div>
                    <p>Enterprise-grade components...</p>
                  </GlowingCard>
                  <GlowingCard glowColor="#f59e0b" className="space-y-4">
                    <div className="container" style={{ padding: '0', backgroundColor: 'transparent', height: 'auto', width: '100%', display: 'flex', flexDirection: 'row' }}>
                      <img src="/images/energy-saving-light.png" alt="" style={{ width: '12%', height: '12%' }} />
                      <h3 style={{ marginLeft: '10px', color: '#e2b85c' }}>Ý nghĩa của hệ thống</h3>
                    </div>
                    <p>Enterprise-grade components...</p>
                  </GlowingCard>
                </GlowingCards>
