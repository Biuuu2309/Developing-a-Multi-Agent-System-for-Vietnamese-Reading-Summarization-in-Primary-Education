                  ...
                  <GlowingCard glowColor="#ff1493" className="space-y-4">
                    ...
                    >
                      <div className="p-2 text-justify">
                        ...
                        Với mục tiêu tạo bản tóm tắt diễn giải chất lượng ngắn gọn, dễ hiểu, đầy đủ và chính xác, mô hình tóm tắt diễn giải đã đạt được kết quả rất khả quan với F1 = , ROUGE-1 = , ROUGE-L = , BERTScore = . 
                      </div>
                    </InteractiveGradient>
                  </GlowingCard>
                </GlowingCards>
