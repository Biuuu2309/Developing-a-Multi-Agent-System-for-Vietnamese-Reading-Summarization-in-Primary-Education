...
export default function Home() {
  ...
  return (
    <div style={{ width: '100%', minHeight: '100vh', position: 'relative' }}>
      <div className="fixed-logo" style={{ display: 'flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'center' }}>
        <img src="/images/logo.png" alt="" style={{ width: '100px', height: '100px', backgroundColor: 'transparent' }} />
          <AuroraTextEffect 
            text="VUSUMMARY" 
