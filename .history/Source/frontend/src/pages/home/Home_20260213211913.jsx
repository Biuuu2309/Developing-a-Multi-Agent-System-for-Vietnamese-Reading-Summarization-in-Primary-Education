                  ...
                  <GlowingCard glowColor="#ff1493" className="space-y-4">
                    <div style={{ width: '100%', padding: 0, margin: 0 }}>
                      <InteractiveGradient
                        ...
                        className="p-0"
                      >
                        <div className="p-3 text-white rounded-xl" style={{ display: 'flex', flexDirection: 'row', alignItems: 'center', width: '100%', justifyContent: 'center', border: '3px solid #ff1493', boxSizing: 'border-box' }} >
