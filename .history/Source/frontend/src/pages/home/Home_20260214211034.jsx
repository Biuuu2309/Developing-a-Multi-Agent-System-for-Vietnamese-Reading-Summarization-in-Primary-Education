                ...
                <ScrollList
                  ...
                  renderItem={(item) => (
                    <div className="p-4 bg-white rounded-xl shadow-md">
                      <h3 className="font-semibold" style={{ fontSize: '1.2rem', fontFamily: 'sans-serif', fontWeight: 'bold' }}>{item.title}</h3>
                      <p className="text-gray-600" style={{ fontSize: '1rem', fontFamily: 'sans-serif', fontWeight: 'normal' }}>{item.description}</p>
                    </div>
                  )}
                  itemSpacing={24}
                />
