                ...
                <GlowingCards>
                  <GlowingCard glowColor="#ff1493" className="space-y-4">
                    <InteractiveGradient
                      ...
                      borderRadius="1.5rem"
                    >
                      <div className="p-3 text-white border-3 border-pink-300 rounded-xl" style={{ display: 'flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'center', width: '100%', boxSizing: 'border-box' }} >
