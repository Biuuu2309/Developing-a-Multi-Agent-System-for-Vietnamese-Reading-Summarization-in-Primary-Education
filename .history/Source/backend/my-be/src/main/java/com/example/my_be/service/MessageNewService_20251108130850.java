    ...
    public MessageResponse createMessage(CreateMessageRequest request) {
        ...
        try {
            ...
            try {
                ...
                System.out.println("MAS API response body: " + (response.getBody() != null ? response.getBody().substring(0, Math.min(200, response.getBody().length())) : "null"));
                ...
                System.err.println("MAS API server error: " + e.getStatusCode() + " - " + e.getMessage());
                throw new RuntimeException("MAS API server error: " + e.getStatusCode() + " - " + e.getMessage(), e);
            }
