...
def input_classifier_agent(state: AgentState):
    ...
    try:
        ...
        if "greeting" in classification:
            ...
            if len(user_input) < 30 and any(word in user_lower for word in ["chào", "hello", "hi", "xin chào", "chào bạn", "chào", "hey"]):
                classification = "greeting"
        ...
        user_lower = user_input.lower()
        if len(user_input) < 20 and any(word in user_lower for word in ["chào", "hello", "hi", "xin chào"]):
            classification = "greeting"
