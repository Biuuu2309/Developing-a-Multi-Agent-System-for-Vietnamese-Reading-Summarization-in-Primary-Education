...
if __name__ == "__main__":
    ...
    if args.text:
        ...
        print('python main.py --text "Cá chép và gà nhí thi vẽ. Cá chép vẽ nó làm vua. Gà nhí vẽ gà mẹ chăm lũ gà em. Cô cò, chú trắm chấm thi. Họ cho là gà nhí vẽ vừa đẹp vừa có ý nghĩa."')
        print()
