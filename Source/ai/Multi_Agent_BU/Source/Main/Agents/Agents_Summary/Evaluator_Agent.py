...
1. Đánh giá chất lượng bản tóm tắt TRÍCH XUẤT hay DIỄN GIẢI dựa trên các tiêu chí sau:
    1.1. Tóm tắt TRÍCH XUẤT:
...
2. Đưa ra điểm số từ 0-10 dựa trên độ dễ hiểu, điểm dựa trên độ mạch lạc, điểm dựa trên ý nghĩa, điểm dựa trên độ liên kết giữa các câu
